...
{
    class CashInEndHandler final : public XFS4IoTServer::ICommandHandler
    {
    public:
        CashInEndHandler(
    ...
    private:
        ...
        {
            std::shared_ptr<XFS4IoT::CashAcceptor::Completions::CashInEndCompletionPayloadData> payload;
            XFS4IoT::MessageHeader::CompletionCodeEnum completionCode;
            std::string errorDescription;
        };

        boost::asio::awaitable<CommandResult> HandleCashInEnd(
            std::shared_ptr<XFS4IoT::CashAcceptor::Commands::CashInEndCommand> cashInEnd,
