...
{
    class GetServicesCommand final : public XFS4IoT::Commands::Command<XFS4IoT::MessagePayloadBase>
    {
    public:
        static constexpr const char* CommandName = "ServicePublisher.GetServices";
        static constexpr const char* Version = "1.0";

        GetServicesCommand(int requestId, int timeout)
        ...
        static std::shared_ptr<XFS4IoT::MessageBase> FromJson(const nlohmann::json& j)
        {
            ...
            return std::make_shared<GetServicesCommand>(requestId, timeout);
        }
    ...
    inline bool GetServicesCommand::registered_ = []()
        {
            XFS4IoT::MessageBase::RegisterMessage(
                typeid(GetServicesCommand),
                GetServicesCommand::CommandName,
                GetServicesCommand::Version);
            return true;
        }();
}